...
**Multi-Format Delivery:** Outputs professional reports in Markdown (for VS Code/GitHub) and CSV (for Project Management tools).

**Unicode/UTF-8 Compliant:** Engineered for cross-platform reliability, supporting international characters and professional formatting.

**Project Management Logic:** Automatically assigns priority levels and identifies responsible stakeholders from raw dialogue.
